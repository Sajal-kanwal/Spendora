                ...
                <CardHeader className="gap-2">
                    <CardTitle className="grid grid-flow-row justify-between gap-2 md:grid-flow-col">
                        ...
                        <div className="flex h-10 gap-2">
                            ...
                            <Badge variant={"outline"} className="flex items-center gap-2 text-sm">
                                <div className="h-4 w-4 rounded-full bg-rose-400"></div>
                                Expense
                            </Badge>
                        </div>
                    </CardTitle>
                            ...
                            !dataAvailable && (
                                <Card className="flex h-[300px] flex-col items-center justify-center bg-background">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Try selecting a different date range or adding new transactions.
                                    </p>
                                </Card>
                            )
                        }
...
function CustomTooltip({active, payload, formatter}:any) {
    ...
    return (
        <div className="min-w-[300px] rounded border bg-background p-4">
            ...
            <TooltipRow formatter={formatter} label="Balance" value={income - expense} bgColor="bg-indigo-100" textColor="text-foreground" />
        </div>
    )
