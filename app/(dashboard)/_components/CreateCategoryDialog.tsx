...
function CreateCategoryDialog({type, successCallback}: Props) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="bg-background border border-border shadow-2xl z-50 backdrop-blur-md sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>
                        Create <span className={cn(
                            "m-1", type === "income" ? "text-emerald-500" : "text-rose-500"
                    )}>
                        {type}
                    </span>
                        category
                    ...
                    <DialogDescription>
                        Organize your finances with categories.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({field}) =>(
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        This is how your category will appear throughout the app.
                                    </FormDescription>
                                </FormItem>
                            )}
                        />
                                    ...
                                    <FormControl>
                                        <Popover>
                                            ...
                                            <PopoverContent className="w-full">
                                                <Picker data={data} theme={theme.resolvedTheme} onEmojiSelect={(emoji:{native:string}) => { field.onChange(emoji.native);}}
                                                />
                                            </PopoverContent>
                                        </Popover>
                                    </FormControl>
                                    <FormDescription>
                                        This icon will visually represent the category across the application interface.
                                    </FormDescription>
                                </FormItem>
                            )}
                        />
